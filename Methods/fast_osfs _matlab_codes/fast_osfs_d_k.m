function   [selected_features1,time]=fast_osfs_d_k(data1,target,alpha,test,k1)


%for disccrete data, limit the size of the currrently selected feature set to k1
...
dep=-1*ones(1,p-1);
 ...
 for i=1:p-1%the last feature is the class attribute, i.e., the target)
     ...
     stop=0;
      ...
      [CI,dep(i)] = my_cond_indep_chisquare(data1,i, target, [], test, alpha, ns);
                    ...
                    l_s=length(selected_features);
                     ...
                     if l_s>k1
                       ...
                       if isempty(index_1)% if current_feature set doesn't contain i, then consider the next feature
                           ...
                           b1=setdiff(selected_features,i, 'stable');
